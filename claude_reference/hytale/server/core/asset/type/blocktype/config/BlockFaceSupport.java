...
public class BlockFaceSupport implements NetworkSerializable<com.hypixel.hytale.protocol.BlockFaceSupport> {
   ...
   public static BlockFaceSupport rotate(@Nonnull BlockFaceSupport original, @Nonnull Rotation rotationYaw, @Nonnull Rotation rotationPitch, @Nonnull Rotation roll) {
      if (original == ALL) {
         ...
         Vector3i[] rotatedFiller = (Vector3i[])ArrayUtil.copyAndMutate(original.filler, (vector) -> {
            return Rotation.rotate(vector, rotationYaw, rotationPitch, roll);
         }, (x$0) -> {
            return new Vector3i[x$0];
         });
   ...
   static {
      CODEC = ((Builder)((Builder)((Builder)BuilderCodec.builder(BlockFaceSupport.class, BlockFaceSupport::new).append(new KeyedCodec("FaceType", Codec.STRING), (blockFaceSupport, s) -> {
         blockFaceSupport.faceType = s;
      }, (blockFaceSupport) -> {
         return blockFaceSupport.faceType;
      }).add()).documentation("Can be any string. Compared with FaceType in \"Support\". A LOT of blocks use 'Full'.")).append(new KeyedCodec("Filler", new ArrayCodec(Vector3i.CODEC, (x$0) -> {
         return new Vector3i[x$0];
      })), (blockFaceSupport, o) -> {
         blockFaceSupport.filler = o;
      }, (blockFaceSupport) -> {
         return blockFaceSupport.filler;
      }).add()).build();

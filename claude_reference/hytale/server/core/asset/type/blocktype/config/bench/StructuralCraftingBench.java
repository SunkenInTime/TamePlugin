...
public class StructuralCraftingBench extends Bench {
   ...
   static {
      CODEC = ((Builder)((Builder)((Builder)((Builder)((Builder)BuilderCodec.builder(StructuralCraftingBench.class, StructuralCraftingBench::new, Bench.BASE_CODEC).append(new KeyedCodec("Categories", new ArrayCodec(Codec.STRING, (x$0) -> {
         return new String[x$0];
      })), (bench, categories) -> {
         bench.sortedCategories = categories;
      }, (bench) -> {
         return bench.sortedCategories;
      }).add()).append(new KeyedCodec("HeaderCategories", new ArrayCodec(Codec.STRING, (x$0) -> {
         return new String[x$0];
      })), (bench, headerCategories) -> {
         bench.headerCategories = headerCategories;
      }, (bench) -> {
         return bench.headerCategories;
      }).add()).append(new KeyedCodec("AlwaysShowInventoryHints", Codec.BOOLEAN), (bench, alwaysShowInventoryHints) -> {
         bench.alwaysShowInventoryHints = alwaysShowInventoryHints;
      }, (bench) -> {
         return bench.alwaysShowInventoryHints;
      }).add()).append(new KeyedCodec("AllowBlockGroupCycling", Codec.BOOLEAN), (bench, allowBlockGroupCycling) -> {
         bench.allowBlockGroupCycling = allowBlockGroupCycling;
      }, (bench) -> {
         return bench.allowBlockGroupCycling;
      }).add()).afterDecode(StructuralCraftingBench::processConfig)).build();
   }
}

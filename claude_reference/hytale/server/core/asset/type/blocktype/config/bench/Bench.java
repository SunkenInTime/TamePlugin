...
public abstract class Bench implements NetworkSerializable<com.hypixel.hytale.protocol.Bench> {
   ...
   static {
      BASE_CODEC = ((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)BuilderCodec.abstractBuilder(Bench.class).addField(new KeyedCodec("Id", Codec.STRING), (bench, s) -> {
         bench.id = s;
      }, (bench) -> {
         return bench.id;
      })).addField(new KeyedCodec("DescriptiveLabel", Codec.STRING), (bench, s) -> {
         bench.descriptiveLabel = s;
      }, (bench) -> {
         return bench.descriptiveLabel;
      })).appendInherited(new KeyedCodec("TierLevels", new ArrayCodec(BenchTierLevel.CODEC, (x$0) -> {
         return new BenchTierLevel[x$0];
      })), (bench, u) -> {
         bench.tierLevels = u;
      }, (bench) -> {
         return bench.tierLevels;
      }, (bench, parent) -> {
         bench.tierLevels = parent.tierLevels;
      }).add()).append(new KeyedCodec("LocalOpenSoundEventId", Codec.STRING), (bench, s) -> {
         bench.localOpenSoundEventId = s;
      }, (bench) -> {
         return bench.localOpenSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.ONESHOT).add()).append(new KeyedCodec("LocalCloseSoundEventId", Codec.STRING), (bench, s) -> {
         bench.localCloseSoundEventId = s;
      }, (bench) -> {
         return bench.localCloseSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.ONESHOT).add()).append(new KeyedCodec("CompletedSoundEventId", Codec.STRING), (bench, s) -> {
         bench.completedSoundEventId = s;
      }, (bench) -> {
         return bench.completedSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.MONO).addValidator(SoundEventValidators.ONESHOT).add()).append(new KeyedCodec("FailedSoundEventId", Codec.STRING), (bench, s) -> {
         bench.failedSoundEventId = s;
      }, (bench) -> {
         return bench.failedSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.MONO).addValidator(SoundEventValidators.ONESHOT).add()).append(new KeyedCodec("BenchUpgradeSoundEventId", Codec.STRING), (bench, s) -> {
         bench.benchUpgradeSoundEventId = s;
      }, (bench) -> {
         return bench.benchUpgradeSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.MONO).addValidator(SoundEventValidators.ONESHOT).add()).append(new KeyedCodec("BenchUpgradeCompletedSoundEventId", Codec.STRING), (bench, s) -> {
         bench.benchUpgradeCompletedSoundEventId = s;
      }, (bench) -> {
         return bench.benchUpgradeCompletedSoundEventId;
      }).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.MONO).addValidator(SoundEventValidators.ONESHOT).add()).afterDecode((bench) -> {
   ...
   public static class BenchSlot {
      public static final BuilderCodec<Bench.BenchSlot> CODEC;
      ...
      static {
         CODEC = ((Builder)BuilderCodec.builder(Bench.BenchSlot.class, Bench.BenchSlot::new).addField(new KeyedCodec("Icon", Codec.STRING), (benchSlot, s) -> {
            benchSlot.icon = s;
         }, (benchSlot) -> {
            return benchSlot.icon;
         })).build();
      }
   }
}

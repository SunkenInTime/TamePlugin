...
public class BlockMovementSettings implements NetworkSerializable<com.hypixel.hytale.protocol.BlockMovementSettings> {
   ...
   static {
      CODEC = ((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)BuilderCodec.builder(BlockMovementSettings.class, BlockMovementSettings::new).append(new KeyedCodec("IsClimbable", Codec.BOOLEAN), (blockMovementSettings, o) -> {
         blockMovementSettings.isClimbable = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.isClimbable;
      }).add()).append(new KeyedCodec("IsBouncy", Codec.BOOLEAN), (blockMovementSettings, o) -> {
         blockMovementSettings.isBouncy = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.isBouncy;
      }).add()).append(new KeyedCodec("BounceVelocity", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.bounceVelocity = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.bounceVelocity;
      }).add()).append(new KeyedCodec("ClimbUpSpeedMultiplier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.climbUpSpeedMultiplier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.climbUpSpeedMultiplier;
      }).add()).append(new KeyedCodec("ClimbDownSpeedMultiplier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.climbDownSpeedMultiplier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.climbDownSpeedMultiplier;
      }).add()).append(new KeyedCodec("ClimbLateralSpeedMultiplier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.climbLateralSpeedMultiplier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.climbLateralSpeedMultiplier;
      }).add()).append(new KeyedCodec("Drag", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.drag = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.drag;
      }).add()).append(new KeyedCodec("Friction", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.friction = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.friction;
      }).add()).append(new KeyedCodec("TerminalVelocityModifier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.terminalVelocityModifier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.terminalVelocityModifier;
      }).add()).append(new KeyedCodec("HorizontalSpeedMultiplier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.horizontalSpeedMultiplier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.horizontalSpeedMultiplier;
      }).add()).append(new KeyedCodec("JumpForceMultiplier", Codec.FLOAT), (blockMovementSettings, o) -> {
         blockMovementSettings.jumpForceMultiplier = o;
      }, (blockMovementSettings) -> {
         return blockMovementSettings.jumpForceMultiplier;
      }).add()).build();
   }
}

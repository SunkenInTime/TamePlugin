...
public class AmbienceFXSound implements NetworkSerializable<com.hypixel.hytale.protocol.AmbienceFXSound> {
   ...
   static {
      CODEC = ((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)BuilderCodec.builder(AmbienceFXSound.class, AmbienceFXSound::new).append(new KeyedCodec("SoundEventId", Codec.STRING), (ambienceFXSound, o) -> {
         ambienceFXSound.soundEventId = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.soundEventId;
      }).addValidator(Validators.nonNull()).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).add()).addField(new KeyedCodec("Play3D", new EnumCodec(AmbienceFXSoundPlay3D.class)), (ambienceFXSound, o) -> {
         ambienceFXSound.play3D = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.play3D;
      })).append(new KeyedCodec("BlockSoundSetId", Codec.STRING), (ambienceFXSound, o) -> {
         ambienceFXSound.blockSoundSetId = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.blockSoundSetId;
      }).addValidator(BlockSoundSet.VALIDATOR_CACHE.getValidator()).add()).addField(new KeyedCodec("Altitude", new EnumCodec(AmbienceFXAltitude.class)), (ambienceFXSound, o) -> {
         ambienceFXSound.altitude = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.altitude;
      })).addField(new KeyedCodec("Frequency", ProtocolCodecs.RANGEF), (ambienceFXSound, o) -> {
         ambienceFXSound.frequency = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.frequency;
      })).addField(new KeyedCodec("Radius", ProtocolCodecs.RANGE), (ambienceFXSound, o) -> {
         ambienceFXSound.radius = o;
      }, (ambienceFXSound) -> {
         return ambienceFXSound.radius;

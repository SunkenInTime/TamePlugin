...
public class AmbienceFXBlockSoundSet implements NetworkSerializable<com.hypixel.hytale.protocol.AmbienceFXBlockSoundSet> {
   ...
   static {
      CODEC = ((Builder)((Builder)((Builder)BuilderCodec.builder(AmbienceFXBlockSoundSet.class, AmbienceFXBlockSoundSet::new).append(new KeyedCodec("BlockSoundSetId", Codec.STRING), (ambienceFXBlockSoundSet, s) -> {
         ambienceFXBlockSoundSet.blockSoundSetId = s;
      }, (ambienceFXBlockSoundSet) -> {
         return ambienceFXBlockSoundSet.blockSoundSetId;
      }).addValidator(Validators.nonNull()).addValidator(BlockSoundSet.VALIDATOR_CACHE.getValidator()).add()).addField(new KeyedCodec("Percent", ProtocolCodecs.RANGEF), (ambienceFXBlockSoundSet, o) -> {
         ambienceFXBlockSoundSet.percent = o;
      }, (ambienceFXBlockSoundSet) -> {
         return ambienceFXBlockSoundSet.percent;
      })).afterDecode(AmbienceFXBlockSoundSet::processConfig)).build();
